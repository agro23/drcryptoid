...
// constructor (public name: string, public author: string, public uploadDate: string, public articleHeader: string, public firstParagraph: string, public bodyCopy: string[], public link: string) {}
testArticle1 = new Article(1, "Bitcoin?", "Andy Grossberg", "10/10/18", "Webtwo Ipsum Ngmoco Groupon Appjet Ngmoco, Bitcoin?", "Knewton appjet heroku unigo, bebo. Blekko ifttt jabber jumo heroku vuvox jibjab, fleck eskobo mozy meebo. Lijit trulia lijit dopplr napster, yoono kosmix. Chegg zimbra ning greplin etsy plugg movity tumblr, cuil jibjab yammer sococo jumo. Waze chartly ifttt, akismet. Wikia greplin balihoo zinch ifttt, stypi loopt plaxo.",
